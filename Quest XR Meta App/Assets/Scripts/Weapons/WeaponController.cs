...
public class WeaponController : MonoBehaviour
{
    ...
    public ProjectileBase projectilePrefab1;
    public ProjectileBase projectilePrefab2;
    public ProjectileBase projectilePrefab3;
    ...
    [Tooltip("The aiming point using gaze control")]
    ...
    void Update()
    {
        ...
        //Uncomment if you want to use one gun with different prefab in the muzzle
        //UpdateRoomControl();
        

    }

    void UpdateRoomControl()
    {
        if (RoomControl.room1 == true && RoomControl.room2 == false && RoomControl.room3 == false)
        {
            projectilePrefab = projectilePrefab1;
        }
        else if (RoomControl.room2 = false && RoomControl.room2 == true && RoomControl.room3 == false)
        {
            projectilePrefab = projectilePrefab2;
        }
        else if (RoomControl.room1 == false && RoomControl.room2 == false && RoomControl.room3 == true)
        {
            projectilePrefab = projectilePrefab3;
        }
        else
        {
            projectilePrefab = projectilePrefab1;
    ...
    public bool HandleShootInputs(bool inputDown, bool inputHeld, bool inputUp)
    {
        switch (shootType)
        {
            case WeaponShootType.Manual:
                if (inputDown)
                {
                    Debug.Log("Shoot manual InputDown");
                    return TryShoot();
                }
                return false;
    ...
    {
        Debug.Log("TryShoot function was called");
        if (m_CurrentAmmo >= 1f 
    ...
    {
        Debug.Log("HandleShoot option was called");
