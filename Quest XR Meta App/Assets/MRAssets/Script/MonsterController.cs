...
public class MonsterController : MonoBehaviour
{
    ...
    public static int counterKillMonsters = 0;


    private int countRedMummy = 0;
    private int countBlueMummy = 0;
    private int countGreenMummy = 0;
    ...
    {
        //if (other.transform.name != "Bullet 1(Clone)")
        //return;

        

        if (gameObject.name == "Mummy_Monster_Red(Clone)" && other.transform.name == "Bullet 1(Clone)")
        {
            Debug.Log("countRedMummy: " + countRedMummy);
            Debug.Log("countShootToKill: " + shootToKill);
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);
            if (countRedMummy >= shootToKill)
            {
        ...
        else if (gameObject.name == "Mummy_Monster_Blue(Clone)" && other.transform.name == "Bullet 2(Clone)")
        {
            Debug.Log("countBlueMummy: " + countBlueMummy);
            Debug.Log("countShootToKill: " + shootToKill);
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);
            if (countBlueMummy >= shootToKill)
            {
                gameObject.SetActive(false);
                counterKillMonsters++;
            }
        ...
        else if (gameObject.name == "Mummy_Monster_Green(Clone)" && other.transform.name == "Bullet 3(Clone)")
        {
            Debug.Log("countGreenMummy: " + countGreenMummy);
            Debug.Log("countShootToKill: " + shootToKill);
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);
            if (countGreenMummy >= shootToKill)
            {
        ...
        else if (gameObject.name == "Oppy_Red(Clone)" && other.transform.name == "Bullet 1(Clone)")
        {
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);
            gameObject.SetActive(false);
            counterKillMonsters++;
        ...
        else if (gameObject.name == "Oppy_Blue(Clone)" && other.transform.name == "Bullet 2(Clone)")
        {
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);
            gameObject.SetActive(false);
            counterKillMonsters++;
        ...
        else if (gameObject.name == "Oppy_Green(Clone)" && other.transform.name == "Bullet 3(Clone)")
        {
            Instantiate(onDeadParticleEffect, transform.position, Quaternion.identity);  
            gameObject.SetActive(false);
            counterKillMonsters++;
